...
public:
	...
	bool write_zahl(int zahl)
	{
		file.write((char *)& zahl, sizeof(zahl));
		return file.good();
	}
	bool read_zahl(int & zahl)
	{
		file.read((char *)& zahl, sizeof(zahl));
		return file.good();
	}
	bool write_zahl(unsigned int zahl)
	{
		file.write((char *)& zahl, sizeof(zahl));
		return file.good();
	}
	bool read_zahl(unsigned int & zahl)
	{
		file.read((char *)& zahl, sizeof(zahl));
		return file.good();
	}
	bool write_zahl(float zahl)
	{
		file.write((char *)& zahl, sizeof(zahl));
		return file.good();
	}
	bool read_zahl(float & zahl)
	{
		file.read((char *)& zahl, sizeof(zahl));
		return file.good();
	}
	bool write_zahl(double zahl)
	{
		file.write((char *)& zahl, sizeof(zahl));
		return file.good();
	}
	bool read_zahl(double & zahl)
	{
		file.read((char *)& zahl, sizeof(zahl));
		return file.good();
	}
